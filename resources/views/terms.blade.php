<x-layouts.base-layout>
    ...
    <div class="terms">
        <h4>利用規約</h4>
        <br>
        <p>この規約は、お客様が、Mookie（以下「当社」）が提供する「制限タグ帳」アプリケーション（以下「本アプリ」）をご利用頂く際の取扱いにつき定めるものです。本規約に同意した上で本サービスをご利用ください。</p>
        <br>
        <h5>第１条（定義）</h5>
        <p>本規約上で使用する用語の定義は、次に掲げるとおりとします。</p>
        <table>
            <tr>
                <td class="terms-first-td">（1）本サービス</td>
                <td>当社が運営するアプリケーション及び関連するサービスやウェブサイト</td>
            </tr>
            <tr>
                <td>（2）本コンテンツ</td>
                <td>本アプリ上で提供される文字、音、静止画、動画、ソフトウェアプログラム、コード等の総称（投稿情報を含む）</td>
            </tr>
            <tr>
                <td>（3）利用者</td>
            ...
            <tr>
                <td>（8）登録情報</td>
                <td>登録利用者が本サービスにて登録した情報の総称（投稿情報は除く）</td>
            </tr>
            <tr>
                <td>（9）知的財産</td>
        ...
        <ol>
            ...
            <li>利用者が、本サービスをパソコン、タブレット、スマートフォンその他の情報端末上で利用し、本規約への同意手続を行った時点で、利用者と当社との間で、本規約の諸規定に従った利用契約が成立するものとします。</li>
        ...
        <ol>
            ...
            <li>入会の申込をした方は、弊社がその申込を承諾し、ＩＤ登録が完了した時点から登録ユーザーとなります。</li>
            <li>弊社は、登録ユーザー向けにメールで連絡事項の告知や広告その他の情報提供を行います。あらかじめご了承ください。</li>
            <li>弊社は、登録希望者が次の各号のいずれか一つに該当する場合は、弊社の判断により入会申込を承諾しないことがあります。</li>
            <ul>
                <li>登録希望者が、弊社の定める方法によらず入会の申込を行った場合</li>
        ...
        <p><a href="/privacy">「プライバシーポリシー」はこちら</a></p>
        <br>
        <h5>第７条（禁止行為）</h5>
        ...
        <ol>
            ...
            <li>当社は、本サービスが全ての情報端末に対応していることを保証するものではなく、本サービスの利用に供する情報端末のＯＳのバージョンアップ等に伴い、本サービスの動作に不具合が生じる可能性があることにつき、利用者はあらかじめ了承するものとします。当社は、かかる不具合が生じた場合に当社が行うプログラムの修正等により、当該不具合が解消されることを保証するものではありません。</li>
            <li>利用者は、Google Chrome、Microsoft Edge、Safari、Firefox等のブラウザの利用規約および運用方針の変更等に伴い、本サービスの一部又は全部の利用が制限される可能性があることをあらかじめ了承するものとします。</li>
        ...
        <br>
        <h5>第１３条（準拠法、管轄裁判所）</h5>
        <ol>
            <li>本規約の有効性，解釈及び履行については，日本法に準拠し，日本法に従って解釈されるものとします。</li>
            <li>当社と利用者等との間での論議・訴訟その他一切の紛争については、訴額に応じて、福岡簡易裁判所又は福岡地方裁判所を専属的合意管轄裁判所とします｡</li>
        </ol>
        <br>
        ２０２４年５月１３日　施行 
    </div>
