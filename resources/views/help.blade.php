<x-layouts.base-layout>
    ...
    <div class="how-to-use">
        <h3>１．コンセプト</h3>
        <p>「制限タグ帳」では、<font class="emphasis">活動範囲を絞って突き抜ける</font>を主なコンセプトとしています。</p>
        <p>これまでの仕事や活動など様々な人生経験を通して、自分の得意/不得意、好き/嫌い、興味/関心などの傾向をおおよそ把握できた人が、これから自分の強みを生かせる活動の範囲やジャンルを絞り込み、より深掘りしていく、磨き上げていくフェーズに特におすすめしたいアプリです。</p>
        <p>使い方は人それぞれですが、仕事などの場面では、良い習慣を継続して獲得していく、突き抜けた能力やスキルを掛け算して、より希少価値の高い人材になることを目指せます。また他にも、多機能だったり選択肢が自由すぎるツールが苦手な方にもおすすめです。</p>
        <br>
        <h3>２．様々な制限とそのねらい</h3>
        <p>「制限タグ帳」では以下のような制限を設け、様々な力を養うことをねらっています。</p>
        <ul>
            <li>タグの作成は５つまで：<font class="emphasis">突き抜けたい活動を決める、そして深める</font></li>
            <li>ノートの投稿は１タグにつき１日１投稿まで：<font class="emphasis">継続力＝良習慣</font></li>
            <li>ノートの投稿日は変更不可（後日まとめて投稿などはできない）：<font class="emphasis">スピード力</font></li>
            <li>ノートの本文は 200文字以上 800文字以内：<font class="emphasis">執筆力、推敲力</font></li>
            <li>ノートの中断保存は１つのみ可能：<font class="emphasis">完結力</font></li>
            </li>
            <li>投稿済みノートの編集は不可：<font class="emphasis">注意力、諦める力</font></li>
            <li>ズルしにくいアプリ仕様：自分自身や外部に対しての<font class="emphasis">証明力</font></li>
        </ul>
        <br>
        <h3>３．ページ構成と機能</h3>
        ...
        <ul>
            ...
            <li><font class="emphasis">検索フォームに条件の選択（任意）やキーワードを入力</font>し、「検索」ボタンで該当のノートを検索します。また、「リセット」ボタンで検索フォームの全項目を空欄にできます。</li>
            <li>それまでに執筆してきた、<font class="emphasis">タグ削除分も含めたすべての投稿済みノートから検索</font>できます。</li>
        </ul>
        <br>
        <h4>【home / ホーム】ページ</h4>
        <ul>
            <li>[ <img src="{{ asset('/images/home-icon.png') }}" alt="ホーム" /> ] アイコンをクリックすると、ホーム（ノート最新100）ページに入ります。また、アプリにログイン後、最初に表示されるページです。</li>
            <li>投稿した<font class="emphasis">最新のノート100件分が表示</font>されます。また、各タグ名（略称）クリックで、タグ別にも表示できます。</li>
            <li>各ノートのカードをクリックすると、内容の詳細が確認できます。</li>
        </ul>
        <br>
        ...
        <ul>
            ...
            <li>今後、正規版アプリ制作に向けて、このページでの追加機能を予定しています。</li>
        </ul>
        <br>
        <h4>【help / ヘルプ】ページ</h4>
        <ul>
            ...
            <li>お問い合わせフォームへのリンクを設置しているので、制限タグ帳に関するお問い合わせの際はこちらからお願いします。</li>
        </ul>
        <br>
        <h4>その他のページ</h4>
        <ul>
            ...
            <!-- TODO -->
            <li>右上の著作権表示テキスト [© 2024 Mookie] は当社サイトへのリンクになっており、当社のコンテンツや制作アプリ情報などがご確認いただけます（現在サイト準備中）。</li>
        </ul>
        <br>
    </div>
    <br>
